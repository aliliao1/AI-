...
const TextAnalyzer: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const analysisResult = await analyzeContent('Text', text);
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-semibold text-slate-100 mb-2">文字內容詐騙分析</h2>
        <p className="text-slate-400">
          貼上可疑的簡訊、Email 或任何文字訊息，AI 將為您分析其中隱藏的詐騙風險。
        </p>
      </div>
